...
if ( ! class_exists( 'OT_Settings' ) ) {
  ...
  class OT_Settings {
      ...
      foreach( (array) $this->options as $option ) {
        ...
        foreach( (array) $this->get_pages( $option ) as $page ) {
          ...
          if ( ! isset( $page['hidden_page'] ) ) {
            ...
            /* add styles */
            add_action( 'admin_print_styles-' . $page_hook, array( $this, 'anariel_styles' ) );
     ...
     * @since     2.0
     */
    public function anariel_styles() {
      ot_admin_styles();
    }
          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            echo '<div class="wrap settings-wrap" id ="page-' . $page['id'] . '">';
              ...
              echo '<h2>' . $theme->get( 'Name' ) .' '. $page['page_title'] . '</h2>';
				echo '<div class="pmc-licence" style="display:none">';
				...
				// echo '		<h2>Lite version of Anariel theme</h2>
				...
				// 		<li>Ability to change typography via theme options</li>
				// 		<li>Six diffrent layout to import</li>
				// 		<li>Auto updates</li>
				// 		<li>Premium support</li>
				// 		</ul>';
				// echo '		<a class="buy-freya button" title = "Click to check out the Premium Version" href ="https://premiumcoding.com/wordpress-themes/anariel-lifestyle-wordpress-blog-theme/" target = "_blank">Buy Anariel now and save 20% with discount code "anariellite"</a>';
				echo '</div>';

              echo ot_alert_message( $page );

              settings_errors( 'anariel' );

              /* Header */
              echo '<div id="option-tree-header-wrap" style="display:none">';
                echo '<ul id="option-tree-header">';

                  echo '<li id="pmc-tree-logo"><a href="'.LINK.'"><img src="'.ICON.'"></a></li>';
                  echo '<li id="option-tree-version"><span>' . $theme->get( 'Name' ) . ' '. esc_attr__('Version: ','anariel') . $theme->get( 'Version' ).'</span></li>';
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
                ...
                /* Sub Header */
                echo '<div id="option-tree-sub-header" style="display:none">';
