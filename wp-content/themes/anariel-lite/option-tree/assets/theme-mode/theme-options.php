...
Three posts below the slider allows you to add extra content that is not connected to your blog posts. The content can be anything from custom images to adverts.',
      ...
      array(
        ...
        'desc'        => 'You can add up to 3 categories and sort them with drag and drop.',
        'std'         => '',
        'type'        => 'list-item',
        'section'     => 'post_box',
        'rows'        => '',
...
Instagram block above the footer can display your latest images from your Instagram. It\'s not connected to the Instagram in the sidebar, you can set that under Appearance -&gt; Widgets.',
      ...
      array(
        'id'          => 'singe_fullwidth',
        'label'       => 'Display as fullwidth layout?',
        'desc'        => 'Check this if you wish to display single post fullwidth (without a sidebar).',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'blog_pages',
        'rows'        => '',
      ...
      array(
        'id'          => 'singe_sidebar',
        'label'       => 'Use different sidebar?',
        'desc'        => 'Check this if you wish to use a different sidebar (Sidebar - Posts) for single posts.',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'blog_pages',
        'rows'        => '',
...
//       ),
      ...
      array(
        ...
        'desc'        => 'Check this if you wish to display related posts under the content of each post. Related posts are three posts that are connected to the current post via categories.',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'blog_pages',
        'rows'        => '',
