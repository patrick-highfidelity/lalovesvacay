 ...
 */
add_action( 'widgets_init', 'anariel_category_select_post_widget' );
/* Function that registers our widget. */
function anariel_category_select_post_widget() {
	register_widget( 'anariel_category_select_posts' );
}
class anariel_category_select_posts extends WP_Widget {
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'category_select_posts', 'description' => esc_attr__('Displays the post image and excerpt from a selected category','anariel') );
		/* Create the widget. */
		parent::__construct( 'category_select_posts-widget', esc_attr__('Anariel - Premium Posts','anariel'), $widget_ops, '' );
	}
	...
	function form( $instance ) {
		...
		<p>
			...
			<br /><small><?php echo esc_attr('(select category to display)','anariel') ?></small>
		</p>
		<p>
