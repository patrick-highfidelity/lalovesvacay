...
<?php if(anariel_globals('display_post_meta')) { ?>
	<div class = "post-meta">
		...
		$year= get_the_time('Y');
		?>
		<?php echo '<a class="post-meta-time" href="'.get_day_link( $year, $month, $day ).'">'; ?><?php echo date("M d, Y", strtotime(get_the_date())); ?></a> <a class="post-meta-author" href="<?php echo  the_author_meta( 'user_url' ) ?>"><?php esc_html_e('by ','anariel'); echo get_the_author(); ?></a> 
